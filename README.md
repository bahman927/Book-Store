The Book-Store is a Django-React that applies adding book to database. You can see the whole books in database. furthermore you can add book to database.
